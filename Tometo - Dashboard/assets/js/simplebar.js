...
!(function (t, e) {
  ...
  return (function (t) {
            ...
            [
              {
                ...
                value: function () {
                  (this.el.SimpleBar = this),
                    ...
                    (this.scrollContentEl.style.paddingRight = "".concat(
                    ...
                    0 !== this.scrollbarWidth &&
                      (this.contentEl.style.marginRight = "-".concat(
                        this.scrollbarWidth,
                        "px"
                      )),
                    this.recalculate(),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  (this.dragOffset[e] =
                    r - n.getBoundingClientRect()[this.offsetAttr[e]]),
                    (this.currentAxis = e),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var i =
                    ...
                    s =
                      o * this.contentEl[this.scrollSizeAttr[this.currentAxis]];
              ...
              },
              {
                ...
                value: function (e) {
                  return Object.keys(t.htmlAttributes).reduce(function (n, r) {
                    ...
                    return (
                      e.hasAttribute(i) &&
                        (n[r] = JSON.parse(e.getAttribute(i) || !0)),
                      n
                    );
                  }, {});
                },
        ...
        "Array",
        {
          from: function (t) {
            ...
            if (
              ...
              for (f = m.call(h), n = new d(); !(i = f.next()).done; y++)
    ...
    function (t, e, n) {
      var r, i, o;
      /*!scrollbarWidth.js v0.1.3 | felixexter | MIT | https://github.com/felixexter/scrollbarWidth*/ !(function (
        n,
        s
      ) {
        (i = []),
    ...
    function (t, e, n) {
      ...
      function o(t) {
        for (
          var e = ["top", "right", "bottom", "left"], n = {}, i = 0, o = e;
          i < o.length;
          i += 1
        ) {
          var s = o[i],
      ...
      function c(t) {
        ...
        if (
          ("border-box" === s.boxSizing &&
            (Math.round(h + u) !== e && (h -= i(s, "left", "right") + u),
      ...
      (O.prototype.addObserver = function (t) {
        ~this.observers_.indexOf(t) || this.observers_.push(t),
          this.connected_ || this.connect_();
      }),
        (O.prototype.removeObserver = function (t) {
        ...
        (O.prototype.onTransitionEnd_ = function (t) {
